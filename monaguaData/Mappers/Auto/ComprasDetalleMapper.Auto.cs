...
Entities.EstadosCompraActividad EstadosCompraActividadEntity = null; // Lazy load
            ((IMappeableComprasDetalle)entity).CompleteEntity(ActividadesEntity, ComprasEntity, EstadosCompraActividadEntity);
        }
        ...
        /// 
        /// </summary>
        public ComprasDetalleList GetByEstadosCompraActividad(DbTransaction transaction, System.Int32 IdEstadoCompraActividad)
        {
            return base.GetObjectListByAnyStoredProcedure(transaction, StoredProceduresPrefix() + "ComprasDetalle_GetByEstadosCompraActividad", IdEstadoCompraActividad);
        }

        /// <summary>
        /// 
        /// </summary>
        public ComprasDetalleList GetByEstadosCompraActividad(DbTransaction transaction, IUniqueIdentifiable EstadosCompraActividad)
        {
            return base.GetObjectListByAnyStoredProcedure(transaction, StoredProceduresPrefix() + "ComprasDetalle_GetByEstadosCompraActividad", EstadosCompraActividad.Identifier());
        }
        ...
        /// 
        /// </summary>
        public ComprasDetalleList GetByEstadosCompraActividad(System.Int32 IdEstadoCompraActividad)
        {
            return base.GetObjectListByAnyStoredProcedure(StoredProceduresPrefix() + "ComprasDetalle_GetByEstadosCompraActividad", IdEstadoCompraActividad);
        }

        /// <summary>
        /// 
        /// </summary>
        public ComprasDetalleList GetByEstadosCompraActividad(IUniqueIdentifiable EstadosCompraActividad)
        {
            return base.GetObjectListByAnyStoredProcedure(StoredProceduresPrefix() + "ComprasDetalle_GetByEstadosCompraActividad", EstadosCompraActividad.Identifier());
        }
        ...
        /// 
        /// </summary>
        public void DeleteByEstadosCompraActividad(System.Int32 IdEstadoCompraActividad)
        {
            base.DataBaseHelper.ExecuteNoQueryByStoredProcedure(StoredProceduresPrefix() + "ComprasDetalle_DeleteByEstadosCompraActividad", IdEstadoCompraActividad);
        }

        /// <summary>
        /// 
        /// </summary>
        public void DeleteByEstadosCompraActividad(DbTransaction transaction, System.Int32 IdEstadoCompraActividad)
        {
            base.DataBaseHelper.ExecuteNoQueryByStoredProcedure(transaction, StoredProceduresPrefix() + "ComprasDetalle_DeleteByEstadosCompraActividad", IdEstadoCompraActividad);
        }
        ...
        /// 
        /// </summary>
        public void DeleteByEstadosCompraActividad(IUniqueIdentifiable EstadosCompraActividad)
        {
            base.DataBaseHelper.ExecuteNoQueryByStoredProcedure(StoredProceduresPrefix() + "ComprasDetalle_DeleteByEstadosCompraActividad", EstadosCompraActividad.Identifier());
        }

        /// <summary>
        /// 
        /// </summary>
        public void DeleteByEstadosCompraActividad(DbTransaction transaction, IUniqueIdentifiable EstadosCompraActividad)
        {
            base.DataBaseHelper.ExecuteNoQueryByStoredProcedure(transaction, StoredProceduresPrefix() + "ComprasDetalle_DeleteByEstadosCompraActividad", EstadosCompraActividad.Identifier());
        }
...
namespace monaguaRules.Wrappers
{
    ...
    public class ComprasDetalleMapperWrapper
    {
        ...
        /// Get a ComprasDetalleList by calling a Stored Procedure
        /// </summary>
        public Entities.ComprasDetalleList GetByEstadosCompraActividad(System.Int32 IdEstadoCompraActividad)
        {
            return Instance().GetByEstadosCompraActividad(IdEstadoCompraActividad);
        }

        /// <summary>
        /// Get a ComprasDetalleList by calling a Stored Procedure
        /// </summary>
        public Entities.ComprasDetalleList GetByEstadosCompraActividad(IUniqueIdentifiable EstadosCompraActividad)
        {
            return Instance().GetByEstadosCompraActividad(EstadosCompraActividad);
        }
        ...
        /// <summary>
        /// Delete ComprasDetalle by EstadosCompraActividad
        /// </summary>
        public void DeleteByEstadosCompraActividad(System.Int32 IdEstadoCompraActividad)
        {
            Instance().DeleteByEstadosCompraActividad(IdEstadoCompraActividad);
        }
        ...
        public void DeleteByEstadosCompraActividad(IUniqueIdentifiable EstadosCompraActividad)
        {
            Instance().DeleteByEstadosCompraActividad(EstadosCompraActividad);
        }
        ...
        /// Save ComprasDetalle 
        /// </summary>
        public void Save(System.Int32 IdCompraDetalle, System.Int32 IdCompra, System.Int32 IdActividad, System.Int32 Cantidad, System.DateTime FechaHora, System.Decimal MontoActividad, System.Int32 IdEstadoCompraActividad){
            ...
            entity.IdEstadoCompraActividad = IdEstadoCompraActividad;
            Instance().Save(entity);
        }
        ...
        /// Insert ComprasDetalle
        /// </summary>
        public void Insert(System.Int32 IdCompra, System.Int32 IdActividad, System.Int32 Cantidad, System.DateTime FechaHora, System.Decimal MontoActividad, System.Int32 IdEstadoCompraActividad){
...
Entities.EstadosCompraActividad EstadosCompraActividadEntity = null; // Lazy load
        ...
        /// 
        /// </summary>
        public ObjectList<T> GetByEstadosCompraActividad(DbTransaction transaction, System.Int32 IdEstadoCompraActividad)
        {
            return base.GetObjectListByAnyStoredProcedure(transaction, StoredProceduresPrefix() + "ComprasDetalle_GetByEstadosCompraActividad", IdEstadoCompraActividad);
        }
        ...
        /// 
        /// </summary>
        public ObjectList<T> GetByEstadosCompraActividad(DbTransaction transaction, IUniqueIdentifiable EstadosCompraActividad)
        {
            return base.GetObjectListByAnyStoredProcedure(transaction, StoredProceduresPrefix() + "ComprasDetalle_GetByEstadosCompraActividad", EstadosCompraActividad.Identifier());
        }
        ...
        /// 
        /// </summary>
        public ObjectList<T> GetByEstadosCompraActividad(System.Int32 IdEstadoCompraActividad)
        {
            return base.GetObjectListByAnyStoredProcedure(StoredProceduresPrefix() + "ComprasDetalle_GetByEstadosCompraActividad", IdEstadoCompraActividad);
        }
        ...
        /// 
        /// </summary>
        public ObjectList<T> GetByEstadosCompraActividad(IUniqueIdentifiable EstadosCompraActividad)
        {
            return base.GetObjectListByAnyStoredProcedure(StoredProceduresPrefix() + "ComprasDetalle_GetByEstadosCompraActividad", EstadosCompraActividad.Identifier());
        }
